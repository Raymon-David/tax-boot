...
public class AllInvoiceProcess extends BaseProcess {
    ...
    public void allInvoiceImport(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (int i = 0; i < mapList.size(); i++) {
            ...
            allInvoiceInfoTemp.setProjectId(mapList.get(i).get("project_id"));
            ...
            allInvoiceInfoTemp.setContractId(mapList.get(i).get("contract_id"));
            ...
            allInvoiceInfoTemp.setInceptionOfLease(DateUtil.parse(mapList.get(i).get("inception_of_lease")));
            ...
            allInvoiceInfoTemp.setBillingObjectId(mapList.get(i).get("billing_object_id"));
            ...
            allInvoiceInfoTemp.setCashflowId(mapList.get(i).get("cashflow_id"));
            allInvoiceInfoTemp.setCfItem(mapList.get(i).get("cf_item"));
            allInvoiceInfoTemp.setCfItemDesc(mapList.get(i).get("cf_item_desc"));
            allInvoiceInfoTemp.setTimes(mapList.get(i).get("times"));
            allInvoiceInfoTemp.setLastReceivedDate(DateUtil.parse(mapList.get(i).get("last_received_date")));
            allInvoiceInfoTemp.setDueDate(DateUtil.parse(mapList.get(i).get("due_date")));
            allInvoiceInfoTemp.setDueAmount(new BigDecimal(mapList.get(i).get("due_amount")));
            allInvoiceInfoTemp.setPrincipal(new BigDecimal(mapList.get(i).get("principal")));
            allInvoiceInfoTemp.setInterest(new BigDecimal(mapList.get(i).get("interest")));
            allInvoiceInfoTemp.setReceivedAmount(new BigDecimal(mapList.get(i).get("received_amount")));
            allInvoiceInfoTemp.setReceivedPrincipal(new BigDecimal(mapList.get(i).get("received_principal")));
            allInvoiceInfoTemp.setReceivedInterest(new BigDecimal(mapList.get(i).get("received_interest")));
            allInvoiceInfoTemp.setNotreceivedAmount(new BigDecimal(mapList.get(i).get("notreceived_amount")));
            allInvoiceInfoTemp.setNotreceivedPrincipal(new BigDecimal(mapList.get(i).get("notreceived_principal")));
            allInvoiceInfoTemp.setNotreceivedInterest(new BigDecimal(mapList.get(i).get("notreceived_interest")));
            allInvoiceInfoTemp.setBillingAmount(new BigDecimal(mapList.get(i).get("billing_amount")));
            allInvoiceInfoTemp.setBillingPrincipal(new BigDecimal(mapList.get(i).get("billing_principal")));
            allInvoiceInfoTemp.setBillingInterest(new BigDecimal(mapList.get(i).get("billing_interest")));
            allInvoiceInfoTemp.setNeedBillingAmount(new BigDecimal(mapList.get(i).get("notbilling_amount")));
            allInvoiceInfoTemp.setNotbillingPrincipal(new BigDecimal(mapList.get(i).get("notbilling_principal")));
            allInvoiceInfoTemp.setNotbillingInterest(new BigDecimal(mapList.get(i).get("notbilling_interest")));
            allInvoiceInfoTemp.setVatDueAmount(new BigDecimal(mapList.get(i).get("vat_due_amount")));
            allInvoiceInfoTemp.setVatPrincipal(new BigDecimal(mapList.get(i).get("vat_principal")));
            allInvoiceInfoTemp.setVatInterest(new BigDecimal(mapList.get(i).get("vat_interest")));
            allInvoiceInfoTemp.setNetDueAmount(new BigDecimal(mapList.get(i).get("net_due_amount")));
            allInvoiceInfoTemp.setNetPrincipal(new BigDecimal(mapList.get(i).get("net_principal")));
            allInvoiceInfoTemp.setNetInterest(new BigDecimal(mapList.get(i).get("net_interest")));
            ...
            allInvoiceInfoTemp.setExchangeRate(mapList.get(i).get("exchange_rate"));
            ...
            allInvoiceInfoTemp.setBusinessType(mapList.get(i).get("business_type"));
            allInvoiceInfoTemp.setBusinessTypeDesc(mapList.get(i).get("business_type_desc"));
            allInvoiceInfoTemp.setDivision(mapList.get(i).get("division"));
            ...
            allInvoiceInfoTemp.setBillingWay(mapList.get(i).get("billing_way"));
            allInvoiceInfoTemp.setBillingWayN(mapList.get(i).get("billing_way_n"));
            allInvoiceInfoTemp.setNeedBillingAmount(new BigDecimal(mapList.get(i).get("need_billing_amount")));
            ...
            allInvoiceInfoTemp.setLastWriteOffDate(DateUtil.parse(mapList.get(i).get("last_write_off_date")));
