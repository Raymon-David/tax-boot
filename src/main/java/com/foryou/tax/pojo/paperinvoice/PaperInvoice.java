package com.foryou.tax.pojo.paperinvoice;
 ...
 * @since 2020-03-16
 */
@TableName("PAPER_INVOICE")
public class PaperInvoice implements Serializable {
     ...
     * 纸质发票ID/PK
     */
    @TableId(value = "PAPER_INVOICE_ID", type = IdType.AUTO)
    private Integer paperInvoiceId;
    /**
     * 发票表ID
     */
     ...
     * 购货方手机号
     */
    @TableField("CUST_TPAPERPHONE")
    private String custTpaperphone;
    /**
     * 购方固定电话
     */
     ...
     * 备注
     */
    @TableField("PAPER_INVOICE_MEMO")
    private String paperInvoiceMemo;
    /**
     * 发票类型
     */
    @TableField("PAPER_INVOICE_TYPE")
     ...
     * 纸质发票状态
     */
    @TableField("PAPER_INVOICE_STATUS")
    private String paperInvoiceStatus;
    /**
     * 纸质接口返回的pdf附件URL
     */
    @TableField("PDF_URL")
    ...
    public Integer getPaperInvoiceId() {
        return paperInvoiceId;
    }

    public void setPaperInvoiceId(Integer paperInvoiceId) {
    ...
    public String getCustTpaperphone() {
        return custTpaperphone;
    }

    public void setCustTpaperphone(String custTpaperphone) {
        this.custTpaperphone = custTpaperphone;
    }
    ...
    public String getPaperInvoiceMemo() {
        return paperInvoiceMemo;
    }

    public void setPaperInvoiceMemo(String paperInvoiceMemo) {
        this.paperInvoiceMemo = paperInvoiceMemo;
    }
    ...
    public String getPaperInvoiceStatus() {
        return paperInvoiceStatus;
    }

    public void setPaperInvoiceStatus(String paperInvoiceStatus) {
        this.paperInvoiceStatus = paperInvoiceStatus;
    }
    ...
    public String toString() {
        ...
        ", custTaxNo=" + custTaxNo +
        ", custAddr=" + custAddr +
        ", custTpaperphone=" + custTpaperphone +
        ", custPhone=" + custPhone +
        ", custEmail=" + custEmail +
        ", custBankAccount=" + custBankAccount +
        ", custType=" + custType +
        ", paperInvoiceMemo=" + paperInvoiceMemo +
        ", paperInvoiceType=" + paperInvoiceType +
        ", billDate=" + billDate +
        ", cancelNum=" + cancelNum +
        ", billType=" + billType +
