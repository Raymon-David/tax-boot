CREATE TABLE DCFL_ELE_INVOICE_IMPORT_TEMP (
  SERIAL_NUM varchar(50) NOT NULL COMMENT '请求流水号',
  BILL_TYPE varchar(50) COMMENT '发票种类',
  INVOICE_TYPE varchar(20) COMMENT '开票类型',
  INVOICE_CODE varchar(20) NULL COMMENT '发票代码',
  INVOICE_NUMBER varchar(20) NULL COMMENT '发票号',
  BILL_MACHINE_NUM varchar(50) COMMENT '开票机号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='从页面导入电子发票 临时表';

--先删除后面两个合计数


#HISTORY
CREATE TABLE DCFL_ELE_INVOICE_IMPORT_TEMP_HISTORY
AS
SELECT * FROM DCFL_ELE_INVOICE_IMPORT_TEMP
WHERE 1 = 2
